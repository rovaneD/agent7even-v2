...
<!-- Last reviewed: July 14, 2026 — keep this date current at the end of every session -->
...
- `CONTEXTV29.md` — latest handoff: Foundation rescore persistence hardening after July 14 critical-bug audit.
- `SESSION_2026-07-14.md` — July 14 critical-bug investigation and validation.
