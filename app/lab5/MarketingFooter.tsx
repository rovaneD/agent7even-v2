...
const SOCIAL_LINKS = [
  {
    href: 'https://www.facebook.com/profile.php?id=61556793477497',
    label: 'Agent7even on Facebook',
    icon: (
  ...
  {
    href: 'https://www.instagram.com/agent.7even/',
    label: 'Agent7even on Instagram',
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden fill="currentColor">
  ...
  {
    href: 'https://www.linkedin.com/company/agent7even/',
    label: 'Agent7even on LinkedIn',
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden fill="currentColor">
