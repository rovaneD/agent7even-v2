      ...
      <section className="mb-6 overflow-hidden rounded-2xl border border-gray-100 bg-white">
        <div className="flex flex-col gap-6 p-7 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 className="text-[30px] font-semibold tracking-tight text-text">Brand Identity</h1>
          ...
          return (
            <button
              ...
              className={`flex items-center gap-1.5 rounded-xl px-4 py-2 text-sm font-semibold transition-colors ${
                active ? 'bg-brand-primary text-white shadow-sm' : 'border border-border bg-surface text-text-sec hover:border-brand-primary/30 hover:bg-surface-2 hover:text-text'
              }`}
            >
              <Icon size={13} strokeWidth={1.75} />
              {label}
              {done && <span className="ml-0.5 h-1.5 w-1.5 rounded-full bg-status-success" />}
            </button>
          )
        })}
      </div>
              ...
              <div key={slot.type}>
                ...
                <div className="flex gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 text-xs border border-gray-200 rounded-xl px-3 py-2 focus:outline-none focus:border-brand-primary"
                  />
                  <button
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6">
      <div className="flex items-center justify-between mb-5">
        ...
        <button onClick={addColor} className="flex items-center gap-1 text-sm font-medium text-gray-600 hover:text-brand-primary">
        ...
        <div className="border border-dashed border-gray-200 rounded-2xl p-8 text-center mb-5">
          ...
          <div className="flex items-center justify-center gap-3">
            <button
              ...
              disabled={generating}
              className="flex items-center gap-1.5 px-4 py-2 bg-brand-primary text-white text-[15px] font-medium rounded-xl hover:bg-[#2563EB] disabled:opacity-60 transition-colors"
            >
      ...
      {localColors.length > 0 && !preview && (
        <div className="flex justify-end mb-4">
          <button
            onClick={generatePalette}
            disabled={generating}
            className="flex items-center gap-1.5 text-xs font-medium text-gray-500 hover:text-brand-primary border border-gray-200 rounded-xl px-3 py-1.5 disabled:opacity-50 transition-colors"
          >
          ...
          <div key={color.id} className="flex items-start gap-3 py-3 border-b border-gray-50 last:border-0 sm:items-center">
            ...
            <div className="flex-1 grid min-w-0 grid-cols-2 gap-2 sm:grid-cols-4">
              <input
                ...
                placeholder="Name"
                className="text-sm border border-gray-100 rounded-lg px-2 py-1.5 focus:outline-none focus:border-brand-primary bg-gray-50"
              />
              <input
                value={color.hex}
                ...
                onBlur={() => saveColor(color)}
                placeholder="#000000"
                className="text-sm font-mono border border-gray-100 rounded-lg px-2 py-1.5 focus:outline-none focus:border-brand-primary bg-gray-50"
              />
              <input
                value={color.rgb ?? ''}
            ...
            {pairings.map((pairing, i) => (
              <div key={i} className="bg-white rounded-xl border border-gray-100 p-4 flex flex-col gap-3">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-1.5 py-2 text-[15px] font-medium bg-brand-primary text-white rounded-xl hover:bg-[#2563EB] transition-colors"
                >
            ...
            <div key={role} className="bg-white rounded-2xl border border-gray-100 p-5">
              ...
              <div className="space-y-2.5">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm resize-none focus:outline-none focus:border-brand-primary"
                />
                <button
                  ...
                  className={`w-full flex items-center justify-center gap-1.5 py-2 text-sm font-medium rounded-xl transition-colors ${
                    isSaved ? 'bg-green-50 text-green-700' : 'bg-brand-primary text-white hover:bg-[#2563EB] disabled:opacity-40'
                  }`}
                >
    ...
    <div className="space-y-5">
      <div className="bg-white rounded-2xl border border-gray-100 p-6">
        ...
        <textarea
          ...
          rows={4}
          className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm resize-none focus:outline-none focus:border-brand-primary"
        />
        <div className="flex justify-end mt-3">
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2 text-sm font-medium rounded-xl transition-colors ${
              styleSaved ? 'bg-green-50 text-green-700' : 'bg-brand-primary text-white hover:bg-[#2563EB] disabled:opacity-40'
            }`}
          >
        ...
        <div className="flex gap-2">
          {!editing && (
            <button onClick={() => setEditing(true)}
              className="text-xs font-medium text-gray-600 hover:text-brand-primary px-3 py-1.5 border border-gray-200 rounded-lg transition-colors">
              Edit
            </button>
          )}
          {isFoundation && (
            <button onClick={onRegenerate} disabled={regenerating}
              className="text-xs font-medium text-gray-600 hover:text-brand-primary px-3 py-1.5 border border-gray-200 rounded-lg flex items-center gap-1 transition-colors disabled:opacity-50">
        ...
        <div>
          ...
          <div className="flex gap-2 mt-3">
            <button onClick={handleSave} disabled={saving}
              className="flex items-center gap-1.5 px-4 py-2 bg-brand-primary text-white text-[15px] font-medium rounded-xl disabled:opacity-60">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex items-center gap-1.5 text-[15px] font-medium bg-brand-primary text-white px-4 py-2 rounded-xl hover:bg-[#2563EB] disabled:opacity-40 transition-colors"
          >
                ...
                <div className="flex items-center gap-2">
                  {asset.external_url && (
                    <a href={asset.external_url} target="_blank" rel="noopener noreferrer"
                      className="text-xs text-gray-500 hover:text-brand-primary px-3 py-1.5 border border-gray-200 rounded-lg">
                      Open →
                    </a>
                  )}
