...
import { isPublicIpAddress, validatePublicWebsiteUrl } from '../lib/security/publicWebsiteUrl'
...
async function main(): Promise<void> {
  ...
  assert.deepEqual(blocked.map(result => result.ok), [false, false, false, false, false, false, false])
